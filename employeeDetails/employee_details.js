const employees = [
    ...
    { id: 2, name: 'Alice Smith', age: 28, department: 'HR', salary: 45000, specialization: 'JS' },
...
// const totalSalaries = employees.reduce((previous, current) => {return previous + current});
